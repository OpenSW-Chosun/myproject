...
COLAB_SERVER_URL = 'https://a766-35-198-216-150.ngrok-free.app/api/predict'  # Colab Flask 서버 URL로 변경 필요
...
def process_video(request):
    if request.method == 'POST':
        ...
        #    result = XceptionModel.predict(full_video_path)  # XceptionModel 사용
